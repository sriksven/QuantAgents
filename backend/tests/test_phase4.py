...
class TestRiskAssessorParsing:
    ...
    def test_portfolio_recommendation_parsing(self):
        ...
        raw = json.dumps(
            {
                ...
                "scenarios": [
                    ...
                    },
                    {
                        ...
                        "price_target": 195.0,
                        "return_pct": 6.3,
                        "catalyst": "Steady services growth",
                    },
                    {
                        "label": "bear",
                        "probability": 0.15,
                        "price_target": 162.0,
                        "return_pct": -11.7,
                        "catalyst": "China slowdown",
                    },
                ],
                "catalysts": [
                    {
                        "description": "Q1 2025 earnings",
                        "date_estimate": "2025-01-30",
                        "impact": "positive",
                    }
                ],
        ...
        assert rec.scenarios[0].probability + rec.scenarios[1].probability + rec.scenarios[
            2
